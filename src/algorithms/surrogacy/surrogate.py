...
colsInclude: "list[str]" = ["link", "no_sfcs", "avg_cpu", "avg_memory", "cpu", "memory"]
...
class Surrogate:
    ...
    def trainModel(self, data: pd.DataFrame, isUpdate: bool = False) -> Any:
        """
        Trains the model.
        ...
        epochs: int = 300 if isUpdate else 3000
        model.compile(
            optimizer=tf_keras.optimizers.Adamax(learning_rate=0.025),
